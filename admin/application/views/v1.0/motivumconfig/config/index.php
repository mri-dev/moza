<div class="motiv-configurator" ng-controller="MotifConfigurator" ng-init="init(<?=$this->motivum_id?>, <?=$this->gets[2]?>)">
  <?php if ($this->gets[2] != 0): ?>
    <h1>"<u>{{motivum.config_datas.nev}}</u>" saját minta szerkesztése</h1>
  <?php else: ?>
    <h1>Új motívum hozzáadása</h1>
  <?php endif; ?>

  <div class="right">
    <button type="button" class="btn btn-success" ng-click="editOwnMotivum()">Saját minta adatainak mentése</button>
  </div>
  <br>
  <div class="holder">
    <div class="settings">
      <h3>Beállítás adatok</h3>
      <br>
      <div class="row np">
        <div class="col-md-3">
          Motívum kódja
        ...
        <div class="col-md-3">
          <strong>{{motivum.mintakod}}</strong>
        </div>
      </div>
      <br>
      <div class="row np">
        ...
        <div class="col-md-3">
          <strong>{{motivum.config_datas.ID}}</strong>
        </div>
      </div>
      <br>
      <div class="row np">
        ...
        <div class="col-md-4">
          <input type="text" class="form-control" ng-model="motivum.config_datas.nev">
        </div>
      </div>
      <br>
      <div class="row np">
        ...
        <div class="col-md-1">
          <input type="checkbox" class="form-control" ng-model="motivum.config_datas.lathato">
        </div>
      </div>
      <br>
      <div class="row np">
        ...
        <div class="col-md-1">
          <input type="number" class="form-control" ng-model="motivum.config_datas.sorrend">
        </div>
      </div>
      <br><br>
      <h3>Rétegekek színbeállításai</h3>
      <br>
      <div class="shapes">
        ...
        <div class="shape" ng-repeat="s in motivum.shapes">
          <div class="row">
            ...
            <div class="col-md-4">
              Alapértelmezett: <strong>{{s.original_fill}}</strong>
            </div>
          </div>
          <br>
        </div>
    ...
    <div class="motif-preview">
      ...
      <br>
      <h4>Saját minta - Új színkonfiguráció mentése</h4>
